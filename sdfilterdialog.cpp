...
// 生成高斯拉普拉斯算子（Laplacian of Gaussian, LoG）
...
//    QHBoxLayout *layout6 = new QHBoxLayout;
    ...
    */
    ...
    layout3->addStretch();
    */
    layout5->addWidget(sigmaSlider, 6);
    layout5->addWidget(sigmaEdit, 2);
    //layout7->addStretch();
